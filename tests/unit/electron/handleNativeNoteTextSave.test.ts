...
import type * as TViMockOriginalModule3 from '@electron/file-access/isAllowedOriginalSavePath';
...
vi.mock('@electron/file-access/isAllowedOriginalSavePath', async (importOriginal_2) => ({
