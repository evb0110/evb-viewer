...
Reviewed source: `f0e65666` (`origin/project8/integration`)
...
The current integration CI run is `34637691590` for `f0e65666`. It is queued
at receipt time, so no current-tip hosted pass is claimed. The prior run
`34637592019` was cancelled before terminal acceptance. The separate
...
receipt updates only the dated CI evidence: run `34637691590` is queued for
integration tip `f0e65666`, while run `34637592019` was cancelled before
