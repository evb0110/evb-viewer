...
Reviewed source: `a73dd77d` (`origin/project8/integration`)
...
The current integration CI run is `34634639597` for `a73dd77d`. It completed
cancelled with `gates_ok` failure after every selected acceptance job was
cancelled, so no current-tip hosted pass is claimed. The immediately prior
run `34634424961` was also cancelled before acceptance. The separate
...
receipt updates only the dated CI evidence: run `34634639597` completed
cancelled for integration tip `a73dd77d`, while run `34634424961` was also
