...
Reviewed source: `dd1d48dc` (`origin/project8/integration`)
...
The current integration CI run is `34637592019` for `dd1d48dc`. It is pending
at receipt time, so no current-tip hosted pass is claimed. The prior run
`34637489631` had Quality Gates cancelled before terminal acceptance. The separate
...
receipt updates only the dated CI evidence: run `34637592019` is pending for
integration tip `dd1d48dc`, while run `34637489631` had Quality Gates
