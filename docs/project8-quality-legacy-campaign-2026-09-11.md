...
Reviewed source: `f2b30e8b` (`origin/project8/integration`)
...
The current integration CI run is [`34638361491`](https://github.com/evb0110/evb-viewer/actions/runs/34638361491)
for `f2b30e8b`. It remains in progress at receipt time, so no current-tip
hosted pass is claimed. Its Quality Gates job and platform jobs are still
running. The predecessor run `34638178555` was cancelled before terminal
...
receipt updates only the dated CI evidence: run `34638361491` is in progress
for integration tip `f2b30e8b`, while run `34638178555` was cancelled before
