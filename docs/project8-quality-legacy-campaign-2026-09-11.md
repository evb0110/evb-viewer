...
Reviewed source: `36a46412` (`origin/project8/integration`)
...
The current integration CI run is `34636313258` for `36a46412`. It is pending
at receipt time, so no current-tip hosted pass is claimed. The prior run
`34636023855` remains in progress, while runs `34635826575` and `34635733990`
were cancelled before acceptance. The separate
...
receipt updates only the dated CI evidence: run `34636313258` is pending for
integration tip `36a46412`, while run `34635826575` was cancelled before
acceptance. No supplemental implementation issue was
