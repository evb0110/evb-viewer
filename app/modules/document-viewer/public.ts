...
export {
    clampKeyboardSelection, createKeyboardSelection as createKeyboardSelectionInBounds, createKeyboardSelection, updateKeyboardSelection, updateKeyboardSelection as updateKeyboardSelectionInBounds,
...
export {
    createDocumentOpeningPageFrame, createDocumentOpeningPageFrame as createDocumentOpeningPageFrameAuthority, resolveDocumentOpeningPageMargin, resolveDocumentOpeningPageShellId, type IDocumentOpeningPageFrame, type IDocumentOpeningPageFrame as IDocumentOpeningPageFrameAuthority,
...
export {
    createDocumentProjectionSession, createDocumentProjectionSession as createDocumentSession, ensurePdfProjection, type IDocumentProjectionSession, type IDocumentProjectionSession as IDocumentSession, type TPdfProjectionReason,
...
export {
    createDocumentViewerRuntime, createDocumentViewerRuntime as createDocumentViewerChassisAuthority, documentViewerRuntimeKey, documentViewerRuntimeKey as documentViewerChassisAuthorityKey, injectDocumentViewerRuntime, injectDocumentViewerRuntime as injectDocumentViewerChassisAuthority, shouldAcceptFeaturePackRuntimePage, shouldAcceptFeaturePackRuntimePage as shouldAcceptFeaturePackChassisPage, shouldApplyExternalRuntimePage, shouldApplyExternalRuntimePage as shouldApplyExternalChassisPage, type IDocumentViewerRuntime, type IDocumentViewerRuntime as IDocumentViewerChassisAuthority,
...
export {
    type IDocumentPageMetrics, type IDocumentPageRenderRequest, type IDocumentPageSource, type IDocumentSourceCapabilities, type IDocumentRenderLease, type IDocumentRenderLease as IDocumentSurfaceLease, type TDocumentPageSourceKind, type TDocumentRenderPriority,
...
export {
    settleOpeningPreviewGeometry, settleOpeningPreviewGeometry as settleDocumentOpeningGeometryPrewarmTask,
