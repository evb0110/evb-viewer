...
export default {
    ...
    'annotations': {
        ...
        'selectedProperties': 'Selected annotation properties',
        'mixedValues': 'Mixed',
        'opacity': 'Opacity, %',
        ...
        'stroke': 'Stroke',
        'textSize': 'Text Size',
        'moveTextBox': 'Drag to move text box',
        'textResizeHint': 'Drag the grip to move. Double-click text to edit. Drag a corner to scale text, or a side to change wrapping.',
        'penType': 'Pen Type',
        'pen': 'Pen',
        'pencil': 'Pencil',
        'marker': 'Marker',
        ...
        'noAnnotationsHint': 'Use the tools above to add an annotation.',
        'noMatchingAnnotations': 'No annotations match your search.',
    ...
    'ocr': {
        ...
        'supersession': {
            ...
            'primaryDescriptions': {
                'missing-only': 'Skip pages that already contain usable selectable text; repair hidden OCR layers that do not.',
                'repeat': 'Replace previous recognition results on the selected scanned pages. Original document text is preserved, and unusable hidden OCR is repaired.',
            },
            'advanced': 'Advanced repeat options',
            'options': {
                'missing-only': 'OCR missing or unusable text only',
                'replace-evb': 'Re-OCR EVB text and repair unusable hidden OCR',
                'replace-all': 'Replace all hidden OCR',
            },
            'descriptions': {
                'missing-only': 'Keep usable text layers and OCR pages without usable selectable text.',
                'replace-evb': 'Replace the active EVB OCR generation and repair unusable hidden OCR; visible native text stays untouched.',
                'replace-all': 'Replace EVB and foreign hidden OCR layers; visible native text stays untouched.',
            },
            'onlyEvb': 'Prefer EVB recognition; repair unusable hidden OCR',
        ...
        'languagePicker': {
            ...
            'startWithoutDownload': 'Start OCR',
            'names': {
                'ara': 'Arabic',
                'bul': 'Bulgarian',
                'ces': 'Czech',
    ...
    'scanCleanup': {
        ...
        'preview': {
            ...
            'cleanedImageDecodeFailed': 'The cleaned preview image could not be decoded.',
            ...
            'matchedCanvasProvisional': 'Page size may still change until every page is analyzed.',
        ...
        'errors': {
            ...
            'encrypted': 'This PDF is encrypted. Enter its password and try again.',
            'needsPassword': 'This PDF requires a password before it can be cleaned.',
            'tooLarge': 'The document or its cleaned output is too large to process. Try a smaller page range.',
            'inkPlacementTooLarge': 'Ink placement is unavailable for documents over 20,000 pages. Select a bounded page range or choose another alignment.',
            'corruptXref': 'The PDF index is corrupt and could not be read.',
            'unsupportedFilter': 'This PDF uses an unsupported image filter.',
            'invalidRequest': 'The scan cleanup request is invalid. Review the document and settings, then try again.',
            'io': 'The PDF could not be read or the cleaned result could not be written.',
            'timeout': 'Scan cleanup timed out. Try again.',
            'panic': 'The native scan cleanup engine failed unexpectedly.',
            'nativeFailure': 'The native scan cleanup engine could not complete the operation.',
            'toolsUnavailable': 'The tools required for scan cleanup are unavailable on this system.',
        ...
        'activity': {
            'title': 'Scan cleanup progress',
            'showDetails': 'Show progress details. {status}',
            'phase': {
                'analyze': 'Analyze',
                'clean': 'Clean',
                'finish': 'Finish',
            ...
            'step': {
                'read': 'Read page images',
                'detect': 'Detect page layout',
                'compare': 'Re-check uncertain pages',
            ...
            'stepHint': {
                'read': 'Renders each page as an image for analysis.',
                'detect': 'Finds spreads, skew, margins and the best output mode for each page.',
                'compare': 'Compares pages with the rest of the document and re-reads the uncertain ones.',
                'prepare': 'Measures page resolution and reuses the source image layers where possible.',
                'clean': 'Deskews, crops and cleans every page.',
                'build': 'Writes the cleaned pages into a new PDF.',
                'open': 'Opens the cleaned PDF in a new tab.',
            },
            'stepState': {
                'done': 'Done',
                'active': 'In progress',
            ...
            'detail': {
                ...
                'read': 'Reading page images',
                'detect': 'Detecting page layout',
                'compare': 'Re-checking uncertain pages',
                'calibrate': 'Aligning page placement',
                'starting': 'Starting cleanup',
                'normalizing': 'Preparing document',
                'probing': 'Measuring page resolution',
                'extracting': 'Reading source image layers',
                'rasterizing': 'Rendering page images',
                'classifying': 'Checking page images',
                'rendering': 'Cleaning pages',
                'collecting': 'Collecting results',
                'assembling': 'Building PDF',
                'handoff': 'Opening result',
            },
            'runStartsLater': 'Starts when you click Clean up',
            'rechecked': '{count} re-checked',
            'etaSeconds': 'about {seconds} s left',
            'etaMinutes': 'about {minutes} min left',
            'elapsed': '{time} elapsed',
            'totalElapsed': 'Elapsed {time}',
        },
    ...
    'combinePdf': {
        ...
        'combining': 'Combining...',
        'opening': 'Opening...',
        'openingTitle': 'Opening combined PDF',
        'combineFailed': 'The files could not be combined.',
    ...
    'contextMenu': {
        ...
        'deleteUnderline': 'Delete underline',
        'deleteStrikethrough': 'Delete strikethrough',
        'deleteSquiggly': 'Delete squiggly underline',
    ...
    'pageOps': {
        ...
        'canceling': 'Canceling…',
        'finishing': 'Finishing…',
        'canceled': 'Page operation canceled. The document is unchanged.',
