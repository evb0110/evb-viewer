...
export default defineNuxtConfig({
    ...
    alias: {
        ...
        '@agent-core': fileURLToPath(new URL('./packages/agent-core', import.meta.url)),
    ...
    sourcemap: {
        server: false,
        client: emitSourceMaps ? 'hidden' : false,
    },
    ...
    vite: {
        ...
        worker: {
            format: 'es',
            rolldownOptions: {
                output: {sourcemapExcludeSources: emitSourceMaps},
            },
        },
        css: {
            preprocessorOptions: {
        ...
        build: {
            ...
            rollupOptions: {
                ...
                output: {
                    sourcemapExcludeSources: emitSourceMaps,
