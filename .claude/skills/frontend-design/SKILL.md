...
Before coding, understand the context and commit to a distinctive but mild (not bold) aesthetic direction:
...
Then implement working code (HTML/CSS/JS, Vue, scss, etc.) that is:
- Production-grade and functional
- Academically-looking
...
**IMPORTANT**: Match implementation complexity to the aesthetic vision. Elaborate designs need elaborate code to support them. Elegance comes from executing the vision well.

Remember: Claude is capable of precise yet creative work. Don't hold back, show what can truly be created when thinking outside the box and committing fully to a distinctive vision.
