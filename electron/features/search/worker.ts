...
import type {ICachedIndex} from '@electron/features/search/worker/ensureSearchIndex';
import type {IPdfSearchIndex} from '@electron/features/search/searchIndexTypes';
import type {IXlargeSearchIndexBuildProgress} from '@electron/features/search/xlargeIndexBuilder';
...
import {classifyXlargeSearchPath} from '@electron/features/search/xlargeSearchClassification';
import {
    ensureSearchIndex,
    getIndexCacheKey,
