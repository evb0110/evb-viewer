...
export const NATIVE_PDF_SAVE_DEPENDENCY_PATHS = Object.freeze([
    ...
    'scripts/native-build-id.mjs',
    'scripts/ci/stageExactPdfFixture.ts',
    'tests/e2e/electron/smoke/blockingPdfSaveSmoke.e2e.test.ts',
    'tests/e2e/electron/annotations/annotationLifecycle.e2e.test.ts',
...
const GATE_POLICY_MANIFEST = Object.freeze({
    ci: {changedAreas: {
        browserIntegration: {
            ...
            paths: [
                'app/**',
                // The browser WASM builds, rebuilt from these crates by
