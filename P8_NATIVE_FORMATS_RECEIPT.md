...
- #519 LEGACY-E17: exact POSIX acceptance is qualified in fresh hidden Electron for the literal trailing-space fixture. The trace and p8-e26 result prove raw path preservation through preload/IPC handler/admission/materialization/renderer adoption, edit/save/reopen, exact-target mutation, and qpdf validation. The source regression asserts raw absolute-path preservation and save eligibility for a whitespace-terminated PDF name. The sibling collision/recovery matrix remains open.
